...
import com.eximia.lamiaspesaapp.app.*;
...
public class ScanActivity extends FragmentActivity implements View.OnClickListener, ScanFragment.OnFragmentInteractionListener, ProductFragment.OnFragmentInteractionListener {
    ...
    private Bundle preparaBundle(String format, String content, String prodotto, String descrizione, double rate, String picture) {
    ...
    private void switch2ProductFragment(String format, String content) {
        ...
        Bundle bundle = preparaBundle(format, content, "questo è un test", "test per verificare  fragment_product", 3.1, "");
        ProductFragment productFragment = new ProductFragment();
        productFragment.setArguments(bundle);
        transaction.replace(R.id.fragment_container, productFragment).setTransition(android.app.FragmentTransaction.TRANSIT_FRAGMENT_FADE);
    ...
    private void elaboraRisultatoScan(IntentResult scanningResult) {
        ...
        Log.d(TAG, "elaborato il risultato dello scanner: " + scanContent + " " + scanFormat);
    ...
    private class GetItemInfo extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            Log.d(TAG, "sono in onPostExecute, cerco di parsare il json: " + result);
            try {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.scan_button) {
            ...
            if (sviluppo) interrogaServer("UPC_A", "7313468675004");
            else scanIntegrator.initiateScan();
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.support.v4.app.FragmentTransaction transaction;
        transaction = fm.beginTransaction();
        android.support.v4.app.FragmentTransaction add = transaction.add(R.id.fragment_container, scanFragment);
        add.commit();
