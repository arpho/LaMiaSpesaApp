...
import static com.eximia.lamiaspesaapp.authentication.AccountGeneral.*;


public class EximiaAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "EximiaAuthenticator";
    private final Context mContext;

    public EximiaAuthenticator(Context context) {
        super(context);
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        if (TextUtils.isEmpty(authToken)) {
            ...
            if (password != null) {
                try {
                    Log.d("eximia", TAG + "> re-authenticating with the existing password");
